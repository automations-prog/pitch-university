...
import LicenseSteps from '@/components/license-steps';
...
import type { License, LicenseStatus, LicenseStep } from '@/types';
    ...
    return (
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                <div className="space-y-2">
                    ...
                    <div className="space-y-0.5">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Update the {license.name} license.
                        </p>
                    </div>
                </div>

                <Form {...LicenseController.update.form(license.id)}>
                    {({ processing, errors }) => (
                        <Card>
                            <CardHeader>
                ...
                <LicenseSteps license={license} steps={steps} />
            </div>
        </>
    );
}
